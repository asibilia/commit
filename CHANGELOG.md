...
- bff2866: Migrate release pipeline from semantic-release to changesets, and switch npm publishing to OIDC trusted publishing. No runtime or API change to the CLI — this only affects how releases are cut.
